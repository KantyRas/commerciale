<a class="btn btn-primary" href="<?php echo base_url('Departement/demande/1')?>">Faire une demande</a>
<br/>
<br/>
...
<div class="col-lg-8 d-flex align-items-stretch">
    <div class="card w-100">
        <div class="card-body p-4">
            <h5 class="card-title fw-semibold mb-4">Listes Personnels</h5>
...
<div class="col-lg-8 d-flex align-items-stretch">
    <div class="card w-100">
        <div class="card-body p-4">
            <h5 class="card-title fw-semibold mb-4">Listes Articles</h5>
            <div class="table-responsive">
                <table class="table text-nowrap mb-0 align-middle">
                    <thead class="text-dark fs-4">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="border-bottom-0">
                            <h6 class="fw-semibold mb-1">Categorie</h6>
                            <span class="fw-normal">Ondana</span>
                        </td>
                        <td class="border-bottom-0">
